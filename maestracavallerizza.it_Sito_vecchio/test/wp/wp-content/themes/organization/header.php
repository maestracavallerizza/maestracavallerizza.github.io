...
<html <?php language_attributes(); ?>>
  ...
  <?php do_action('organization_before_site'); ?>
  	<?php 
	if ( function_exists( 'organization_contact_info' ) ) {
	...
	<?php 
	if ( function_exists( 'organization_mobile_header' ) ) {
		//organization_mobile_header(); 
	}?>
		...
		<?php if( is_front_page() ) : ?>
			<?php
				...
				if ( $banner_type == 'video' && is_front_page() ) :
					organization_banner_video();
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					organization_banner_slider();
				else :
					organization_banner_background();
				endif;
			?>
		<?php else : ?>
			<div class="other-header">
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() :organization_get_breadcrumb() );
						}else{
							organization_get_breadcrumb();
						}?></div>
					<?php endif; ?>
				</div>
			</div>
