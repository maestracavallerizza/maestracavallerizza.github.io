 ...
 * Set import files
 */
function organization_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Dummy-data', 'organization'),
            'local_import_file'          => trailingslashit( get_template_directory() ) . 'dummy-data/dummy-data.xml',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'organization_set_import_files' );

/**
 * Define actions that happen after import
 */
function organization_actions_after_import() {
...
add_action( 'pt-ocdi/after_import', 'organization_actions_after_import' );
